...
<header>
    ...
    <div>
        ...
        <h4>Contact Us: 0244000000 Email: acfos@acfos.com WhatApp: 0244000000</h4>
    </div>
    <div>
...
<div id="loginModal" class="modal">
    <div class="modal-content">
        <div class="modal-header">Customer Login</div>
...
<div id="signupModal" class="modal">
    <div class="modal-content">
        <div class="modal-header">Customer Signup</div>
